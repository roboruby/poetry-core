...
task default: %i[test rubocop tokens:verify registry:verify herb:compile version:verify
                 yard:verify yard:coverage yard:coverage:all yard:lint stimulus:docs arch:check arch:order arch:lint]
