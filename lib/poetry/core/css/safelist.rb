...
module Poetry
  module Core
    module CSS
      ...
      # problem (the upstream safelist approach content-path lesson): a host app's
      # Tailwind build can't see classes resolved at render time in Ruby, so
      # the generated safelist file is added to the host's `@source` paths
      # and every dictionary class survives the build.
      #
